    ...
    <div className="space-y-5">
      ...
      <div className="pt-2">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3.5 text-sm font-semibold text-white bg-[#25D366] rounded-full hover:bg-[#128C7E] transition-colors shadow-lg"
        >
